...
const fields = [
    ...
    return (
        <div>
            ...
            <p className='text-sm text-gray-600'>Get Started with the personal
                information</p>
...
{fields.map((field)=>{
    ...
    return (
        <div key={field.key} className='space-y-1 mt-5'>
          ...
          (field.key, e.target.value)} className='mt-1 w-full
    px-3 py-2 border border-gray-300 rounded-lg focus:ring
    focus:ring-blue-500 focus:border-blue-500 outline-none
    transition-colors text-sm' placeholder={`Enter your ${field.label.
